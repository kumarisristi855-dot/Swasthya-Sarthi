  ...
  return (
    <div className="care-shell grid min-h-screen lg:grid-cols-[minmax(600px,1.05fr)_minmax(520px,0.95fr)]">
      ...
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-care-primary-subtle px-5 py-10 sm:px-8">
        ...
        <div className="absolute bottom-8 right-16 h-36 w-80 rounded-[50%] border border-care-primary-hover" aria-hidden="true" />
        <div className="absolute bottom-14 right-8 h-28 w-72 rounded-[50%] border border-care-primary-hover" aria-hidden="true" />
